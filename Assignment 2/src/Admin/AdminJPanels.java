 ...
 * @author yashjain
 */
public class AdminJPanels extends javax.swing.JPanel {
    ...
    public AdminJPanels(Carlist history) {
        initComponents();
    ...
    private void initComponents() {
        ...
        SerialNo.setHorizontalAlignment(javax.swing.SwingConstants.TRAILING);
        SerialNo.setText("Car Serial No");

        SerialNoTxt.setForeground(new java.awt.Color(72, 72, 72));
        ...
        OperatorTxt.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                OperatorTxtActionPerformed(evt);
            }
        });

        Upload.setBackground(new java.awt.Color(0, 83, 170));
        ...
        Upload.setDoubleBuffered(true);
        Upload.setFocusCycleRoot(true);
        Upload.setFocusTraversalPolicyProvider(true);
        Upload.setPreferredSize(new java.awt.Dimension(129, 37));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(BrandTxt, javax.swing.GroupLayout.PREFERRED_SIZE, 110, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(ModelTxt, javax.swing.GroupLayout.PREFERRED_SIZE, 110, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(SerialNoTxt, javax.swing.GroupLayout.PREFERRED_SIZE, 110, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(30, 30, 30)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(OperatorTxt, javax.swing.GroupLayout.PREFERRED_SIZE, 116, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addContainerGap()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(AvailableN, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void OperatorTxtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_OperatorTxtActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_OperatorTxtActionPerformed
        ...
        if (showDialogue == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                ...
                for (int i = 0; i < lines.length; i++) {
                    ...
                    car.setName((String) row[0]);
                    car.setBrand((String) row[1]);
                    car.setModel((String) row[2]);
                    car.setModelNo((String) row[3]);
                    car.setSerialNo((String) row[4]);
                    car.setLocation((String) row[5]);
                    car.setOperator((String) row[6]);
                    car.setAvaliable((String) row[7]);
                    car.setSeat(Integer.parseInt((String) row[8]));
                    car.setMc((String) row[9]);
                    car.setYear(Integer.parseInt(row[10]));
                }
               filterData();
            }catch(Exception e) {
                //  Block of code to handle errors
                System.out.println(e);
                JOptionPane.showMessageDialog(this, "Please Selected Proper File", "Error message", JOptionPane.ERROR_MESSAGE);
            }
    ...
    private void filterData() {
       filterList = history.getHistory();
        ...
        String serial = SerialNoTxt.getText().toLowerCase();
